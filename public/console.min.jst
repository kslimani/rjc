...
var sender = __webpack_require__(52);
...
var Flatted = __webpack_require__(50);
...
exports.create = function (url, options) {
  ...
  function send(f, d) {
    ...
    try {
      ...
      socket.emit('console', {
        f: 'error',
        d: Flatted.stringify(['Remote console sender error: ' + e.message, e])
      });
    }
  }

  socket = socketIO(url, options).on('error', function () {
